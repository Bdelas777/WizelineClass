        ...
        <div className="flex flex-col space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-100 rounded-lg p-4">
                    ...
                    <p className="text-gray-600 bg-white rounded-md p-2">{character.status}</p>
                    <h3 className="text-lg font-bold text-gray-700">Species:</h3>
                    <p className="text-gray-600 bg-white rounded-md p-2">{character.species}</p>
                    <h3 className="text-lg font-bold text-gray-700">Origin:</h3>
                    <p className="text-gray-600 bg-white rounded-md p-2">{character.origin.name}</p>
                </div>
                <div className="bg-gray-100 rounded-lg p-4">
                    <h3 className="text-lg font-bold text-gray-700">Gender:</h3>
                    <p className="text-gray-600 bg-white rounded-md p-2">{character.gender}</p>
                    <h3 className="text-lg font-bold text-gray-700">Location:</h3>
                    <p className="text-gray-600 bg-white rounded-md p-2">{character.location.name}</p>
                </div>
            </div>
            <div className="bg-gray-100 rounded-lg p-4">
