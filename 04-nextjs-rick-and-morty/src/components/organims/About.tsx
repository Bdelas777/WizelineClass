...
export function About() {
  ...
  return (
    <Form
      name="about"
      className="mt-10 w-full max-w-2xl mx-auto flex flex-col items-center p-6 bg-gray-50 shadow-lg rounded-lg"
      onSubmit={handleSubmit}
    >
      <span className="text-3xl font-bold text-gray-700 mb-6">About</span>
      <Label htmlFor="name" className="w-full mb-4">
        <span className="block text-lg font-semibold text-gray-600 mb-2">
          Name
        </span>
        <TextField
          id="name"
      ...
      <Label htmlFor="subject" className="w-full mb-4">
        <span className="block text-lg font-semibold text-gray-600 mb-2">
          Subject
        </span>
        <TextField
